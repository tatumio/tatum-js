...
export type ArbitrumNovaTestnet = EvmBasedRpcSuite
export type AuroraTestnet = EvmBasedRpcSuite
export type AvalancheCTestnet = EvmBasedRpcSuite
export type BinanceSmartChainTestnet = EvmBasedRpcSuite
export type CeloTestnet = EvmBasedRpcSuite
export type CronosTestnet = EvmBasedRpcSuite
export type EthereumGoerli = EvmBasedRpcSuite
export type EthereumSepolia = EvmBasedRpcSuite
export type FantomTestnet = EvmBasedRpcSuite
export type GnosisTestnet = EvmBasedRpcSuite
export type HarmonyOneTestnet = EvmBasedRpcSuite
export type KlaytnBaobab = EvmBasedRpcSuite
export type KucoinTestnet = EvmBasedRpcSuite
export type OasisTestnet = EvmBasedRpcSuite
export type OptimismTestnet = EvmBasedRpcSuite
export type PalmTestnet = EvmBasedRpcSuite
export type PolygonMumbai = EvmBasedRpcSuite
export type VechainTestnet = EvmBasedRpcSuite
