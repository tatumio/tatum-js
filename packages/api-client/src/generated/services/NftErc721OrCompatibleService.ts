         ...
         * {
             ...
             * <pre>{
                ...
                public static nftGetTransactErc721(
                    chain: 'ETH' | 'MATIC' | 'KCS' | 'ONE' | 'KLAY' | 'CELO' | 'TRON' | 'FLOW' | 'BSC' | 'FLR' | 'CRO' | 'BASE' | 'AVAX' | 'FTM' | 'OPTIMISM',
                    hash: string,
                    testnetType?: TestnetType,
                    xTestnetType?: TestnetType,
                ...
                public static nftGetBalanceErc721(
                    chain: 'ETH' | 'MATIC' | 'KCS' | 'ONE' | 'KLAY' | 'CELO' | 'TRON' | 'FLOW' | 'BSC' | 'SOL' | 'ALGO' | 'EGLD' | 'FLR' | 'CRO' | 'BASE' | 'AVAX' | 'FTM' | 'OPTIMISM',
                    address: string,
                ...
                public static nftGetMetadataErc721(
                    chain: 'BSC' | 'CELO' | 'ETH' | 'FLOW' | 'KCS' | 'KLAY' | 'MATIC' | 'ONE' | 'SOL' | 'TRON' | 'ALGO' | 'FLR' | 'CRO' | 'BASE' | 'AVAX' | 'FTM' | 'OPTIMISM',
                    contractAddress: string,
                    tokenId: string,
                    account?: string,
                    testnetType?: TestnetType,
                ...
                public static nftGetContractAddress(
                    chain: 'ALGO' | 'ETH' | 'ONE' | 'KLAY' | 'CELO' | 'TRON' | 'FLOW' | 'MATIC' | 'KCS' | 'BSC' | 'FLR' | 'CRO' | 'BASE' | 'AVAX' | 'FTM' | 'OPTIMISM',
                    hash: string,
