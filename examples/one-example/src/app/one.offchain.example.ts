...
export async function oneOffchainExample() {
  const account = await oneSdk.offchain.depositAddress.checkExists(
  ...
  const assignedAddress = await oneSdk.offchain.depositAddress.assign(
  ...
  await oneSdk.offchain.depositAddress.remove(
    '5e6be8e9e6aa436299950c41',
    '0xa7673161CbfE0116A4De9E341f8465940c2211d4',
  )
