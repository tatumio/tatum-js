...
import { generateWallet as generateBtcWallet } from '@tatumio/tatum-btc/src'
import { generateWallet as generateDogeWallet } from '@tatumio/tatum-doge/src'
import { generateWallet as generateLtcWallet } from '@tatumio/tatum-ltc/src'
import { generateWallet as generateBchWallet } from '@tatumio/tatum-bch/src'
import { generateWallet as generateTronWallet } from '@tatumio/tatum-tron/src'
import { generateWallet as generateFlowWallet } from '@tatumio/tatum-flow/src'
import { generateWallet as generateCeloWallet } from '@tatumio/tatum-celo/src'
import { generateWallet as generateOneWallet } from '@tatumio/tatum-one/src'
import { generateWallet as generateQtumWallet } from '@tatumio/tatum-qtum/src'
import { generateWallet as generateEgldWallet } from '@tatumio/tatum-egld/src'
import { generateWallet as generateEthWallet } from '@tatumio/tatum-eth/src'
import { generateWallet as generatePolygonWallet } from '@tatumio/tatum-polygon/src'
import { generateWallet as generateXdcWallet } from '@tatumio/tatum-xdc/src'
import { generateWallet as generateXrpWallet } from '@tatumio/tatum-xrp/src'
import { generateWallet as generateXlmWallet } from '@tatumio/tatum-xlm/src'
import { generateWallet as generateVetWallet } from '@tatumio/tatum-vet/src'
