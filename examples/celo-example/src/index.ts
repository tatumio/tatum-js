...
console.log(`Running ${celoLedgerAccountExample()}`)
console.log(`Running ${celoLedgerBlockAmountExample()}`)
console.log(`Running ${celoLedgerCustomerExample()}`)
console.log(`Running ${celoLedgerOrderBookExample()}`)
console.log(`Running ${celoLedgerTransactionExample()}`)
