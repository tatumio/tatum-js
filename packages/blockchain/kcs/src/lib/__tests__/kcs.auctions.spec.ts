...
// // auctions functionality does not exist yet

// describe.skip('KcsSDK - auctions', () => {
//   const inmemoryBlockchain = ganacheHelper.inmemoryBlockchain(blockchain)

//   const auctionService = kcsAuctionService({
//     blockchain,
//     web3: {
...
//       auctionTestFactory.prepare.deployAuctionSignedTransaction(auctionService, inmemoryBlockchain.accounts, 'KCS')
//     })
//     describe('create auction', () => {
//       auctionTestFactory.prepare.createAuctionSignedTransaction(auctionService, inmemoryBlockchain.accounts, 'KCS')
//     })
...
//       auctionTestFactory.prepare.auctionBidSignedTransaction(auctionService, inmemoryBlockchain.accounts, 'KCS')
//     })
//     describe('cancel auction', () => {
//       auctionTestFactory.prepare.auctionCancelSignedTransaction(auctionService, inmemoryBlockchain.accounts, 'KCS')
//     })
//     describe('settle auction', () => {
//       auctionTestFactory.prepare.auctionSettleSignedTransaction(auctionService, inmemoryBlockchain.accounts, 'KCS')
//     })
//   })
// })
