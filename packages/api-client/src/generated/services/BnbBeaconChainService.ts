...
export class BnbBeaconChainService {
   ...
   * @throws ApiError
   */
  public static bnbGetBlock(height: number): CancelablePromise<BnbBlock> {
    return __request({
      method: 'GET',
   ...
   * @throws ApiError
   */
  public static bnbGetAccount(address: string): CancelablePromise<BnbAccount> {
    return __request({
      method: 'GET',
   ...
   * @throws ApiError
   */
  public static bnbGetTransaction(hash: string): CancelablePromise<BnbTx> {
    return __request({
      method: 'GET',
   ...
   * @throws ApiError
   */
  public static bnbBroadcast(requestBody: Broadcast): CancelablePromise<TransactionHash> {
    return __request({
      method: 'POST',
