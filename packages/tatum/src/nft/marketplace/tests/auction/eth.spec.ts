...
import { getCurrentBlock } from '@tatumio/tatum-eth'

describe('Auction  tests', () => {
  jest.setTimeout(99999)
  describe('Auction  ETH transactions', () => {
    ...
    it('should get auction', async () => {
      try {
        const auction = await getAuction(Currency.ETH, '0x991dfc0db4cbe2480296eec5bcc6b3215a9b7038', '16420222566821')
    ...
    it('should get auction fee', async () => {
      try {
        const auctionFee = await getAuctionFee(Currency.ETH, '0x93e388c8b4be8c3cc0abfda3700bbc8400cd72d2')
    ...
    it('should get auction fee recipient', async () => {
      try {
        const auctionFeeRecipientAddress = await getAuctionFeeRecipient(Currency.ETH, '0x93e388c8b4be8c3cc0abfda3700bbc8400cd72d2')
