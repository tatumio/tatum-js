...
export async function polygonApiExample() {
  ...
  const address = await polygonSDK.api.polygonGenerateAddress(
    'xpub6EsCk1uU6cJzqvP9CdsTiJwT2rF748YkPnhv5Qo8q44DG7nn2vbyt48YRsNSUYS44jFCW9gwvD9kLQu9AuqXpTpM1c5hgg9PsuBLdeNncid',
    0,
  )
  const wallet = await polygonSDK.api.polygonGenerateWallet(
  ...
  const block = await polygonSDK.api.polygonGetBlock(
  ...
  const transaction = await polygonSDK.api.polygonGetTransaction(
    '0xe6e7340394958674cdf8606936d292f565e4ecc476aaa8b258ec8a141f7c75d7',
  )
  const transactionByAddress = await polygonSDK.api.polygonGetTransactionByAddress(
    '0x8ce4e40889a13971681391aad29e88efaf91f784',
    10,
  )
  const transactionCount = await polygonSDK.api.polygonGetTransactionCount(
