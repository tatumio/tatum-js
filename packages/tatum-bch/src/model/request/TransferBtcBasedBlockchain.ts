...
import { ArrayNotEmpty, IsNotEmpty, IsUUID, Length, Max, Min, Validate, ValidateIf, ValidateNested } from 'class-validator'
import { SignatureIdValidator } from '@tatumio/tatum-core'
import { TransferBtcValidator } from '../validation'
