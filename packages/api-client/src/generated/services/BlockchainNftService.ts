     ...
     * <pre>{
         ...
         * <pre>{
            ...
            public static nftTransferErc721(
                requestBody: (TransferNft | TransferNftCelo | TransferNftTron | TransferNftSolana | TransferNftFlowPK | TransferNftFlowMnemonic | TransferNftKMS | TransferNftKMSCelo | TransferNftKMSTron | TransferNftSolanaKMS | TransferNftFlowKMS),
                xTestnetType: 'ethereum-ropsten' | 'ethereum-rinkeby' = 'ethereum-ropsten',
            ): CancelablePromise<(TransactionHashKMS | SignatureId)> {
                return __request({
                    method: 'POST',
