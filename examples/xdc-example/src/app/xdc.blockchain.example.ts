...
export async function xdcBlockchainExample() {
  const broadcastHash = await xdcSDK.blockchain.broadcast({
  ...
  const transactionsCount = await xdcSDK.blockchain.getTransactionsCount(
    '0x3223AEB8404C7525FcAA6C512f91e287AE9FfE7B',
  )
}
