...
[`v2`](../README.md) is currently under active development and considered alpha version
...
Provide URL to the Tatum API to process.env.TATUM_API_URL variable. Default URL is *https://api.tatum.io* You can
