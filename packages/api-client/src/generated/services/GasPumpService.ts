...
export class GasPumpService {
    ...
    public static precalculateGasPumpAddresses(
        ...
        return __request({
            ...
            errors: {
                400: `The maximum number of addresses to precalculate is exceeded. Use a lower number.`,
     ...
     * When activating gas pump addresses, you are charged a fee for the transaction, and you must sign the transaction with the private key of the blockchain address from which the fee will be deducted.</p>
    ...
    public static activateGasPumpAddresses(
        requestBody: (ActivateGasPump | ActivateGasPumpKMS | ActivateGasPumpTron | ActivateGasPumpTronKMS),
        ...
        return __request({
            ...
            mediaType: 'application/json',
            errors: {
                400: `The maximum number of addresses to activate is exceeded. Use a lower number.`,
                401: `Unauthorized. Not valid or inactive subscription key present in the HTTP Header.`,
                403: `Forbidden. The request is authenticated, but it is not possible to perform the required operation due to a logical error or invalid permissions.`,
                500: `Internal server error. There was an error on the server while processing the request.`,
            },
