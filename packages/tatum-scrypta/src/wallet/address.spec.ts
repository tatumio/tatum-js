...
describe('Address tests', () => {
  it('should generate an address from a mainnet LYRA private key', async () => {
    const address = await generateAddressFromPrivatekey(false, 'SqhJUqY2quSoBBittiKB6U9kSeUccGTBGHsj2jQuh3Uk7AH9H5u7')
  ...
  it.skip('should generate an address from a testnet LYRA private key', async () => {
    const address = await generateAddressFromPrivatekey(true, 'Snb6yv7H3YJ5jzbHZNFRTj3YQ1a6GjDFwPxuPbFEhUg6eniQyopJ')
