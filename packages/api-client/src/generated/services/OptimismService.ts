...
export class OptimismService {
     ...
     * @throws ApiError
     */
    public static optimismGenerateWallet(
        mnemonic?: string,
     ...
     * @throws ApiError
     */
    public static optimismGenerateAddress(
        xpub: string,
        index: number,
    ): CancelablePromise<GeneratedAddressOptimism> {
        return __request({
            method: 'GET',
     ...
     * @throws ApiError
     */
    public static optimismGenerateAddressPrivateKey(
     ...
     * @throws ApiError
     */
    public static optimismWeb3Driver(
        xApiKey: string,
        requestBody: any,
     ...
     * @throws ApiError
     */
    public static optimismGetCurrentBlock(): CancelablePromise<number> {
        return __request({
            method: 'GET',
     ...
     * @throws ApiError
     */
    public static optimismGetBlock(
        hash: string,
    ): CancelablePromise<OptimismBlock> {
        return __request({
            method: 'GET',
     ...
     * @throws ApiError
     */
    public static optimismGetBalance(
        address: string,
    ): CancelablePromise<OptimismBalance> {
        return __request({
            method: 'GET',
     ...
     * @throws ApiError
     */
    public static optimismGetTransaction(
        hash: string,
    ): CancelablePromise<OptimismTx> {
        return __request({
            method: 'GET',
     ...
     * @throws ApiError
     */
    public static optimismGetTransactionCount(
        address: string,
     ...
     * @throws ApiError
     */
    public static optimismBlockchainTransfer(
        requestBody: (TransferOptimismBlockchain | TransferOptimismBlockchainKMS),
     ...
     * @throws ApiError
     */
    public static optimismBlockchainSmartContractInvocation(
        requestBody: (CallSmartContractMethod | CallReadSmartContractMethod | CallOptimismSmartContractMethodCaller | CallSmartContractMethodKMS),
     ...
     * @throws ApiError
     */
    public static optimismBroadcast(
