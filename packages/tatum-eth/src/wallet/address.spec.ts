...
describe('Address tests', () => {
  ...
  it('should generate an address from a mainnet ETH private key', async () => {
    const address = await generateAddressFromPrivatekey('0xac12f9a2d0d1f06c7dc33a3e9c18f60fe1ca65c592d1e9345c994740f9e1971e')
  ...
  it('should generate an address from a testnet ETH private key', async () => {
    const address = await generateAddressFromPrivatekey('0x4cda6d2c33b0f9a041e46474a638ac59aee0734cf208aa9aa2f05ef887bd09e1')
