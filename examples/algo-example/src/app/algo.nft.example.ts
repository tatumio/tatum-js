...
export async function algoNftExample() {
  // This address will deploy an NFT smart contract, then will mint and transfer an NFT to the recipient address, and will finally burn the NFT.
  ...
  // Deploy an NFT smart contract and mint an NFT.
