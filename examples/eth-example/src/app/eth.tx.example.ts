...
export async function ethTxWithSignatureIdExample(): Promise<void> {
  ...
  const preparedTransferFromCustodialWallet =
    await ethSDK.custodial.prepare.transferFromCustodialWallet({
      chain: 'ETH',
      signatureId: 'cac88687-33ed-4ca1-b1fc-b02986a90975',
      contractType: 0,
  ...
  const sentBatchTransferFromCustodialWallet =
    await ethSDK.custodial.send.batchTransferFromCustodialWallet({
      chain: 'ETH',
      signatureId: 'cac88687-33ed-4ca1-b1fc-b02986a90975',
      contractType: [0, 1, 2, 3],
      custodialAddress: '0x009bc01b990e2781e8a961fd792f4ebb12a683b4',
  ...
  const preparedApproveFromCustodialWallet =
    await ethSDK.custodial.prepare.approveFromCustodialWallet({
      chain: 'ETH',
      signatureId: 'cac88687-33ed-4ca1-b1fc-b02986a90975',
      contractType: 0,
