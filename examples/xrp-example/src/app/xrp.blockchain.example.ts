...
export async function xrpBlockchainExample() {
  ...
  const info = await xrpSDK.blockchain.getLastClosedLedger()
  ...
  const tx = await xrpSDK.blockchain.get('1A32A054B04AC9D6814710DDCA416E72C4CD2D78D6C3DFC06CC9369CC4F6B250')
