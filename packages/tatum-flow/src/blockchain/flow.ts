 ...
 */
export const flowGetSignKey = async (isPayer: boolean): Promise<{ keyId: number; address: string }> => get(`/v3/flow/proposal/${isPayer}`)
...
export const flowBroadcastTx = async (txData: string, signatureId?: string, proposalKey?: number) =>
