...
|                | **getBlockHash**    | Returns transactions for address from Btc blockchain.                       |
|                | **getBalance**      | Returns balance on address from Btc blockchain.                             |
| _Transactions_ | **getTransaction**  | Returns transaction by hash from Btc blockchain.                            |
