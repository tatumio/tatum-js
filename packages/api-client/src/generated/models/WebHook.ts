...
export type WebHook = {
     ...
     */
    type: 'INCOMING_BLOCKCHAIN_HOOK' | 'ADDRESS_TRANSACTION' | 'TRADE_MATCH' | 'TRADE_PARTIAL_FILL' | 'PENDING_BLOCKCHAIN_HOOK' | 'TRANSACTION_IN_THE_BLOCK' | 'KMS_FAILED_TX' | 'KMS_COMPLETED_TX';
    /**
     * ID of the WebHook
     */
    id: string;
