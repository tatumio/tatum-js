 ...
 */
export const algorandGetBlock = async (hash: string): Promise<AlgoBlock> => 
    get(`/v3/algorand/block/${hash}`)
 ...
 */
export const algorandGetTransaction = async (hash: string): Promise<AlgoTx> => 
    get(`/v3/algorand/transaction/${hash}`)
