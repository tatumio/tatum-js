import { GenerateCustodialAddress, TransferFromCustodialAddress, prepareTransferFromCustodialWalletAbstract, SmartContractMethodInvocation, TransferFromCustodialAddressBatch, prepareBatchTransferFromCustodialWalletAbstract, ApproveCustodialTransfer, validateBody, ContractType, CustodialFullTokenWallet } from '@tatumio/tatum-core';
...
export const sendCustodialWallet = async (testnet: boolean, body: GenerateCustodialAddress, provider?: string) => {
    let txData = await prepareOneGenerateCustodialWalletSignedTransaction(testnet, body, provider);
...
export const prepareTransferFromCustodialWallet = async (testnet: boolean, body: TransferFromCustodialAddress, provider?: string) => {
    return prepareTransferFromCustodialWalletAbstract(
        ...
        (testnet, body, r, provider) =>
            prepareOneSmartContractWriteMethodInvocation(testnet, r, provider),
