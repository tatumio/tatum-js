...
console.log(`Running ${polygonLedgerAccountExample()}`)
console.log(`Running ${polygonLedgerBlockAmountExample()}`)
console.log(`Running ${polygonLedgerCustomerExample()}`)
console.log(`Running ${polygonLedgerOrderBookExample()}`)
console.log(`Running ${polygonLedgerTransactionExample()}`)
console.log(`Running ${polygonLedgerVirtualCurrencyExample()}`)
