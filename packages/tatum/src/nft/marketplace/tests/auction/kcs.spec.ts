...
import { getCurrentBlock } from '@tatumio/tatum-kcs'

describe('Auction  tests', () => {
  jest.setTimeout(99999)
  describe('Auction  KSC transactions', () => {
    ...
    it('should get auction fee', async () => {
      try {
        const auctionFee = await getAuctionFee(Currency.KCS, '0x93e388c8b4be8c3cc0abfda3700bbc8400cd72d2')
    ...
    it('should get auction fee recipient', async () => {
      try {
        const auctionFeeRecipientAddress = await getAuctionFeeRecipient(Currency.KCS, '0x93e388c8b4be8c3cc0abfda3700bbc8400cd72d2')
