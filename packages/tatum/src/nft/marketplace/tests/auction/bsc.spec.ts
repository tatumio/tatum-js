  ...
  describe('Auction  BSC transactions', () => {
    ...
    it('should prepare deploy auction', async () => {
      ...
      try {
        ...
        console.log(`Prepare deploy auction token:`, token)
    ...
    it('should get auction', async () => {
      try {
        const auction = await getAuction(Currency.BSC, '0x991dfc0db4cbe2480296eec5bcc6b3215a9b7038', '16420222566821')
    ...
    it('should get auction fee', async () => {
      try {
        const auctionFee = await getAuctionFee(Currency.BSC, '0x93e388c8b4be8c3cc0abfda3700bbc8400cd72d2')
    ...
    it('should get auction fee recipient', async () => {
      try {
        const auctionFeeRecipientAddress = await getAuctionFeeRecipient(Currency.BSC, '0x93e388c8b4be8c3cc0abfda3700bbc8400cd72d2')
