import { BurnMultiToken, BurnMultiTokenBatch, Currency, DeployMultiToken, get, MintMultiToken, MintMultiTokenBatch, TransferMultiToken, TransferMultiTokenBatch } from '@tatumio/tatum-core';
import {
