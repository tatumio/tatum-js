import { ETH_DERIVATION_PATH, TESTNET_DERIVATION_PATH } from '@tatumio/tatum-core'
...
/**
 * Generate wallet
 * @param optional mnemonic mnemonic seed to use. If not present, new one will be generated
...
export const generateWallet = (mnemonic?: string, options?: { testnet?: boolean }) => {
  ...
  return generateEthWallet(!!options?.testnet, mnemonic)
}
