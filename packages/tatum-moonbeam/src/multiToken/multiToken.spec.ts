...
describe('NFT tests', () => {
  ...
  describe('NFT moonbeam 1155 transactions', () => {
    it('should test moonbeam 1155 deploy transaction', async () => {
    ...
    it('should test moonbeam 1155 mint transaction', async () => {
      const tokenId = '2'
    ...
    it('should test moonbeam 1155 mint batch transaction', async () => {
      const tokenId = [
        ['12101', '12102'],
        ['12101', '12102'],
      ]
    ...
    it('should test moonbeam 1155 send batch transaction', async () => {
    ...
    it('should test moonbeam 1155 burn transaction', async () => {
    ...
    it('should test moonbeam 1155 burn batch transaction', async () => {
    ...
    it('should test moonbeam 1155 send transaction', async () => {
