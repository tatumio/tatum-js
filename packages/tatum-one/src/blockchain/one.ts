 ...
 */
export const getCurrentBlock = async (): Promise<number> => get(`/v3/one/block/current`)

/**
 * For more details, see <a href="https://tatum.io/apidoc#operation/OneGetBlock" target="_blank">Tatum API documentation</a>
 */
export const getBlock = async (hash: string): Promise<any> => get(`/v3/one/block/${hash}`)

/**
 * For more details, see <a href="https://tatum.io/apidoc#operation/OneGetBalance" target="_blank">Tatum API documentation</a>
 */
export const getBalance = async (address: string): Promise<string> => get(`/v3/one/account/balance/${address}`)
/**
 * For more details, see <a href="https://tatum.io/apidoc#operation/OneGetTransaction" target="_blank">Tatum API documentation</a>
 */
export const getTransaction = async (hash: string): Promise<OneTx> => get(`/v3/one/transaction/${hash}`)
/**
 * For more details, see <a href="https://tatum.io/apidoc#operation/OneGetBalance" target="_blank">Tatum API documentation</a>
 */
export const getTransactionCount = async (address: string): Promise<number> => get(`/v3/one/transaction/count/${address}`)
