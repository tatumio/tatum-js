...
export class SonicTatumApiService {
     ...
     * @throws ApiError
     */
    public static sonicGenerateWallet(
        mnemonic?: string,
     ...
     * @throws ApiError
     */
    public static sonicGenerateAddress(
        xpub: string,
        index: number,
    ): CancelablePromise<GeneratedAddressSonic> {
        return __request({
            method: 'GET',
     ...
     * @throws ApiError
     */
    public static sonicGenerateAddressPrivateKey(
     ...
     * @throws ApiError
     */
    public static sonicGetCurrentBlock(): CancelablePromise<number> {
        return __request({
            method: 'GET',
     ...
     * @throws ApiError
     */
    public static sonicGetBlock(
        hash: string,
    ): CancelablePromise<SonicBlock> {
        return __request({
            method: 'GET',
     ...
     * @throws ApiError
     */
    public static sonicGetBalance(
        address: string,
    ): CancelablePromise<SonicBalance> {
        return __request({
            method: 'GET',
     ...
     * @throws ApiError
     */
    public static sonicGetTransaction(
        hash: string,
    ): CancelablePromise<SonicTx> {
        return __request({
            method: 'GET',
     ...
     * @throws ApiError
     */
    public static sonicGetTransactionCount(
        address: string,
     ...
     * @throws ApiError
     */
    public static sonicBlockchainTransfer(
        requestBody: TransferSonicBlockchain,
     ...
     * @throws ApiError
     */
    public static sonicBlockchainSmartContractInvocation(
        requestBody: (CallSmartContractMethod | CallReadSmartContractMethod | CallSonicSmartContractMethodCaller),
