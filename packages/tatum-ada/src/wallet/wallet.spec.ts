...
describe('Wallet tests', () => {
    ...
    it('should generate wallet for ADA testnet', async () => {
        const wallet = await generateAdaWallet('quantum tobacco key they maid mean crime youth chief jungle mind design broken tilt bus shoulder leaf good forward erupt split divert bread kitten')
