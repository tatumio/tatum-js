...
import { AlgoTransaction, AlgoCreateNFTTransaction, AlgoCreateFTTransaction } from '../model';
...
//         const tx = new AlgoCreateNFTTransaction();
//         tx.from = 'TMETT6BXL3QUH7AH5TS6IONU7LVTLKIGG54CFCNPMQXWGRIZFIESZBYWP4';
...
//         const tx = new AlgoCreateFTTransaction();
//         tx.from = 'TMETT6BXL3QUH7AH5TS6IONU7LVTLKIGG54CFCNPMQXWGRIZFIESZBYWP4';
//         tx.total = 200;
//         tx.decimal = 2;
//         tx.defaultFrozen = false;
