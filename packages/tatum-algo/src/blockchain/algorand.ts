 ...
 */
export const algorandGetTransactionsCount = async (address: string): Promise<number> => get(`/v3/algorand/transaction/count/${address}`)
 ...
 */
export const algorandGetCurrentBlock = async (): Promise<number> => get(`/v3/algorand/block/current`)

/**
 * For more details, see <a href="https://tatum.io/apidoc#operation/AlgorandGetBlock" target="_blank">Tatum API documentation</a>
 */
export const algorandGetBlock = async (roundNumber: string): Promise<AlgoBlock> => get(`/v3/algorand/block/${roundNumber}`)

/**
 * For more details, see <a href="https://tatum.io/apidoc#operation/AlgorandGetBalance" target="_blank">Tatum API documentation</a>
 */
export const algorandGetAccountBalance = async (address: string): Promise<BigNumber> => get(`/v3/algorand/account/balance/${address}`)
