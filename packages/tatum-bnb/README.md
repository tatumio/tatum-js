# Tatum BNB API client
Tatum BNB API client allows browsers and Node.js clients to interact with Tatum API. It includes the following core components.
...
You can find API documentation at [Github Pages](https://tatumio.github.io/tatum-bnb/) or at [API doc](https://tatum.io/apidoc).
