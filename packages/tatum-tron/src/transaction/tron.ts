 ...
 * @returns transaction data to be broadcast to blockchain.
 */
export const prepareTronTrc10SignedTransaction = async (
  testnet: boolean,
 ...
 * @param provider
 */
export const tronGetAccountTrc20Address = async (testnet: boolean, address: string, contractAddress: string, provider?: string) => {
  if (!contractAddress) {
 ...
 * @returns transaction data to be broadcast to blockchain.
 */
export const prepareTronSmartContractInvocation = async (
  testnet: boolean,
 ...
 * @returns transaction data to be broadcast to blockchain.
 */
export const prepareTronTrc10SignedKMSTransaction = async (
  testnet: boolean,
  body: TransferTronTrc10,
  precision?: number,
  provider?: string
