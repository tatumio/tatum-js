...
export const flowLedgerTransactionExample = async () => {
  ...
  const transactionsCountByCustomer = await flowSDK.ledger.transaction.countByCustomer({
    id: '5e6be8e9e6aa436299950c41',
  })
  ...
  const transactionsByCustomer = await flowSDK.ledger.transaction.getAllByCustomer({
    id: '5e6be8e9e6aa436299950c41',
  })
