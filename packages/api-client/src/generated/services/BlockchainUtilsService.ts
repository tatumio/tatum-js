...
export class BlockchainUtilsService {
     ...
     * <h4>2 credits per API call.</h4><br/>
     * <p>Generate new custodial smart contract address on the blockchain. It's possible to enable tokens, which should be detected and supported on that address. This address enables custodial providers to
     ...
     * <h4>2 credits per API call.</h4><br/>
     * <p>Approve transfer of assets from the custodial smart contract wallet.<br/>
     * Supported blockchains:
     * <ul>
     * <li>Binance Smart Chain</li>
     * <li>Harmony.ONE</li>
     ...
     * <h4>2 credits per API call.</h4><br/>
     * <p>Transfer assets from the custodial smart contract wallet. Originator of this transaction must be the address which created the address.
