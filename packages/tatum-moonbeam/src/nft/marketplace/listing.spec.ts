...
import { sendSmartContractMethodInvocationTransaction, sendMoonbeamSmartContractReadMethodInvocationTransaction } from '../../transaction'
...
describe('Marketplace Listing tests', () => {
  ...
  describe('Marketplace Listing GLMR transactions', () => {
    ...
    it('should get marketplace fee', async () => {
      ...
      r.methodABI = listing.abi.find((a) => a.name === r.methodName)
      r.params = []
      console.log(await sendMoonbeamSmartContractReadMethodInvocationTransaction(r, 'https://rpc-mumbai.matic.today'))
    })
