...
export async function celoApiExample() {
  ...
  const address = await celoSDK.api.celoGenerateAddress("xpub6EsCk1uU6cJzqvP9CdsTiJwT2rF748YkPnhv5Qo8q44DG7nn2vbyt48YRsNSUYS44jFCW9gwvD9kLQu9AuqXpTpM1c5hgg9PsuBLdeNncid", 0)
  const wallet = await celoSDK.api.celoGenerateWallet("urge pulp usage sister evidence arrest palm math please chief egg abuse")
