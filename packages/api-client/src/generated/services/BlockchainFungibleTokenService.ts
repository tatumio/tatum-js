...
export class BlockchainFungibleTokenService {
    ...
    public static erc20Deploy(
        requestBody: (ChainDeployErc20 | ChainDeployErc20KMS | ChainDeployKcsErc20 | ChainDeployKcsErc20KMS | ChainDeployCeloErc20 | ChainDeployCeloErc20KMS),
    ...
    public static erc20Transfer(
        requestBody: (ChainTransferAlgoErc20 | ChainTransferAlgoErc20KMS | ChainTransferEthErc20 | ChainTransferEthErc20KMS | ChainTransferKcsEthErc20 | ChainTransferKcsEthErc20KMS | ChainTransferBscBep20 | ChainTransferBscBep20KMS | ChainTransferCeloErc20Token | ChainTransferCeloErc20TokenKMS),
        xTestnetType: 'ethereum-ropsten' | 'ethereum-rinkeby' = 'ethereum-ropsten',
    ): CancelablePromise<(TransactionHashKMS | SignatureId)> {
        return __request({
            method: 'POST',
