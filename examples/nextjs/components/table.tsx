...
export interface TableInterface {
  ...
  isLoading: boolean
  actions?: { delete?: (id: string) => Promise<void>, activate?: (config: any) => Promise<void> | void }
  data: object[]
...
export const Table = ({ attributes, isLoading, actions, data, setOffset, offset, hidePagination }: TableInterface) => {
  ...
  return (
    <div className='w-full my-8'>
      {!isLoading && isShown?.length > 0 ? (<div>
                ...
                return (
                  ...
                  <tr key={item.id} className='bg-white border-b dark:bg-gray-800 dark:border-gray-700'>
                    ...
                    {actions && Object.keys(actions).length > 0 && <td className='px-6 py-4'>
                      {/* @ts-ignore */}
                      {actions?.delete && <a onClick={() => actions.delete && actions.delete(item.id)}
