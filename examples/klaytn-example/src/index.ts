...
import {
  klaytnLedgerAccountExample,
  klaytnLedgerBlockAmountExample,
  klaytnLedgerCustomerExample,
  klaytnLedgerOrderBookExample,
  klaytnLedgerTransactionExample,
  klaytnLedgerVirtualCurrencyExample,
} from './app/klaytn.ledger.example'
...
console.log(`Running ${klaytnLedgerAccountExample()}`)
console.log(`Running ${klaytnLedgerBlockAmountExample()}`)
console.log(`Running ${klaytnLedgerCustomerExample()}`)
console.log(`Running ${klaytnLedgerOrderBookExample()}`)
console.log(`Running ${klaytnLedgerTransactionExample()}`)
console.log(`Running ${klaytnLedgerVirtualCurrencyExample()}`)
