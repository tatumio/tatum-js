...
export async function polygonLedgerAccountExample() {
  ...
  const blockedAmounts = await polygonSDK.ledger.account.getBlockedAmountsByAccountId("5e68c66581f2ee32bc354087")
...
export async function polygonLedgerTransactionExample() {
  ...
  const transactionByReference = await polygonSDK.ledger.transaction.getAllByReference("5e6be8e9e6aa436299950c41")
